...
public class CacheTempCuv {
    ...
    public boolean exists(String tempuv, Long planid, Long uid, String addtime) {
        Jedis jedis = pool.pull();
        try {
            String key = String.format(String.valueOf(RedisKeys.TEMP_CUV_DATE_MAP), planid, addtime), filed = uid + ":" + tempuv;
