 ...
 */
@Entity
@Table(name = "stat_hour_uv")
public class StatHourUv implements Serializable {
    ...
    public StatHourUv(Long hour0, Long hour1, Long hour2, Long hour3, Long hour4, Long hour5, Long hour6, Long hour7, Long hour8, Long hour9, Long hour10, Long hour11, Long hour12, Long hour13, Long hour14, Long hour15, Long hour16, Long hour17, Long hour18, Long hour19, Long hour20, Long hour21, Long hour22, Long hour23) {
        this.hour0 = hour0;
        this.hour1 = hour1;
        this.hour2 = hour2;
        this.hour3 = hour3;
