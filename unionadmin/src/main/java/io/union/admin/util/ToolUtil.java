...
public class ToolUtil {
    ...
    public static String tableFormat(Page<?> page) {
        String table = null;
        try {
            JSONObject result = new JSONObject();
            result.put("total", page.getTotalElements());
            result.put("pageNumber", page.getSize());
            result.put("rows", JSONArray.fromObject(page.getContent()));
