...
import io.union.admin.common.proto.AdsZoneProto;
...
public class CacheAdsZone {
    ...
    public AdsZone save(AdsZone adsZone) {
        Jedis jedis = pool.pull();
        try {
            String key = String.valueOf(RedisKeys.ADS_ZONE_MAP), field = String.valueOf(adsZone.getZoneid());
            AdsZoneProto.AdsZoneMessage message = build(adsZone);
