...
public enum RedisKeys {
    ...
    ADS_ARTICLE_MAP("adsarticlemap"), // 100篇靠前的文章
    ADS_USER_NAME_ID_MAP("adsusernameidmap"), // 所有用户的帐号对应ID
    ADS_KEFU_ID_MAP("adskefumap"), // 平台客服map
    ...
    //ADS_SETTING_CLICK_URL("click_domain"), // 点击跳转的域名地址
    //ADS_SETTING_COUNT_URL("pv_count_domain"), // 计算有效数的域名地址

    ADS_SETTING_JS_URL("js_server_domain"), // 系统JS的服务器地址
    ADS_SETTING_IMG_URL("img_server_domain"), // 系统图片资源的服务器地址
    ADS_SETTING_WEEK_DATE("week_clear"), // 周几是周结的日期
    ADS_SETTING_MONTH_DATE("month_clear"), // 几号是月结的日期
    ADS_SETTING_MIN_PAY("clear_min_pay"), // 最低的支付金额
